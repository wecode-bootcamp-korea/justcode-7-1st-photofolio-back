-- migrate:up
insert into Works_Posting (user_id, category_id, title, content, status_id) values (7, 4, '나는 사자다','안녕하세요 사자입니다.', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (3, 2, '나는 호랑이다','안녕하세요 호랑이입니다', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (8, 3, '나는 앵무새다', '안녕하세요 앵무새입니다.', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (12, 2, '나는 박수호다', '안녕하세요 박수호입니다', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (12, 3, '나는 한혜선이다', '안녕하세요 한혜선입니다', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (7, 2, '나는 송인찬이다', '안녕하세요 송인찬입니다', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (4, 2, '나는 코딩이다', '코딩입니다 반갑습니다', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (5, 4, '나는 9번이다','안녕하세요 9번입니다', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (7, 1, '나는 10번이다', '안녕하세요 10번입니다.', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (3, 3, '나는 11번이다.', '안녕하세요 11번입니다.', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (10, 1, '어제 밥을 먹었어요', '참 맛있었어요', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (8, 4, '오늘도 밥을 먹었어요', '오늘은 맛없었어요', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (1, 4, '짤방 사진입니다', '그냥 짤방입니다', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (12, 4, '15', '저는 15번글이에요 끝내주죠?!', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (1, 2, '18', '저는 사실 17번이에요, 끝내주죠?', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (8, 4, 'NO.poison', '저는 향수입니다', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (1, 2, '안녕하세요 첫 포스팅입니다','저는 첫 포스팅의 내용이죠', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (6, 1, '사실 제가 첫 포스팅이랍니다','저도 첫 포스팅의 내용이랍니다', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (8, 2, 'simple is best','yeah', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (13, 4, '오라클 사용해보셨나요?','사실 저는 mysql 사용자입니다.', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (12, 3, '이게 바로 포토폴리오!','와 진짜 잘만들었네요', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (8, 4, '저 팔로우 해주실 분 계신가요?','맞팔로우 환영', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (4, 4, '이야 이거보세요','우와..', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (12, 4, '이제 4개만 더 만들면 돼요','야호', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (5, 1, '첫 팀프로젝트 하시느라 고생하셨습니다.','이제 시작입니다 여러분', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (9, 2, '잠 못주무신 분들','푹 주무세요', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (11, 1, '사실 더 남았어요','여기에 하고싶은말 써도 되나요?', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (4, 2, '안녕하세요 999번입니다.','바쁘네요', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (1, 4, '고양이.jpg','사실 고양이 아님', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (12, 2, '강아지.png','저 고양이 키워요', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (3, 3, '여기에 쓰면 이게 제목으로 들어가는거죠?','여긴 내용이네요?', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (13, 1, '안녕하세요 감사해요 잘있어요','다시 만나요', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (3, 4, '아침해가 뜨면','매일 같은 사람들과', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (5, 1, '또다시 새로운 하루를','시작해', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (7, 3, '음..제목이겠죠?','내용이네요!', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (4, 4, '이거 작성하고 있어요','데이터가 많네요', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (6, 1, '하고싶은말 쓰고있습니다','이렇게 작성하면 되는거겠죠?', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (8, 1, '안녕하세요 얼룩말입니다','반가워요!', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (3, 2, 'Hello, world','amazing!', 1);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (7, 3, '마켓컬리 편하네요','좋은것같아요', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (1, 1, '네이버 짱','입사시켜주세요', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (5, 3, '헤드폰 추천좀요', '헤드폰은 다이소가 제일 좋아요', 2);
...
insert into Works_Posting (user_id, category_id, title, content, status_id) values (6, 2, '오빠 자?!', '오빠 할말이 있어. 전화 줘', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (11, 1, '오빠 뭐해?', '농사 아닙니다.', 2);
...
insert into Works_Posting (user_id, category_id, title, content, status_id) values (1, 1, '자기야 자?', '자기야 나야... 잘 지내지?', 2);
insert into Works_Posting (user_id, category_id, title, content, status_id) values (11, 3, '여보 돌아와줘', '여보 내가 잘못했어', 2);
...
insert into upload_file (posting_id, file_sort_id, upload_url) values (1, 1, 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=927&q=80');
...
insert into upload_file (posting_id, file_sort_id, upload_url) values (18, 1, 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=927&q=80');
...
insert into upload_file (posting_id, file_sort_id, upload_url) values (22, 1, 'https://images.unsplash.com/photo-1559759708-d6e99b50f0e9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1335&q=80');
...
insert into upload_file (posting_id, file_sort_id, upload_url) values (24, 1, 'https://images.unsplash.com/photo-1553532434-5ab5b6b84993?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80');
